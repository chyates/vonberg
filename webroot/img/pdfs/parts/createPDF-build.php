...
$get_parts = $dbh->query("SELECT 
    ...
    c.name,
    ty.name,
    DATE_FORMAT(p.last_updated, '%M %d, %Y') as date
FROM
    parts as p,
    series as s,
    styles as st,
...
list($description,$categoryID,$category_name,$series_name,$style_name,$connection_name,$type_name,$last_updated) = $part_info;
...
// SCHEMATIC GRAPH
if ( $hs > 0) {
    $hydraulic_graph = "<h3>SCHEMATIC</h3><p><img src='/srv/vonberg.com/htdocs/parts/".$partID."/hydraulic_symbol.jpg'></p>";
} else {
    $hydraulic_graph = "";
}
...
if ($tp > 0) {
    $typical_performance = "<h3>TYPICAL PERFORMANCE</h3><p><img src='/srv/vonberg.com/htdocs/parts/".$partID."/typical_performance.jpg'></p>";
} else {
    $typical_performance = "";
}
...
<td width="40%" style="vertical-align:bottom;text-align:center;">
    <h1 style="font-size:13pt;"><br/>$type_name</h1>
</td>
