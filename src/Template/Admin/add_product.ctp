    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body col-lg-10 mx-auto">
                ...
                <?= $this->Form->create('', ['id' => "add-cat-form", 'class' => 'my-4', 'url' => '#']) ?>
                <?php 
                    echo $this->Form->text('cat',['class'=>'form-control','label'=>'Category Name','id' => "cat", 'placeholder' => 'Enter new category name']);
                ?>
