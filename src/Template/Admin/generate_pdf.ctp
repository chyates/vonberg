<div id="cms-gen-pdf-main" class="inner-main col-md-10 mx-auto p-5">
    <!-- Functions the same as the add new product form. -->
    <form id="gen-pdf-form">
        <h1 id="title-one" class="active-title page-title">Generate Custom PDF</h1>
        <h1 id="title-two" class="inactive-title page-title">Generate Custom PDF: Description and Features</h1>
        <h1 id="title-three" class="inactive-title page-title">Generate Custom PDF: Series Table</h1>
        <h1 id="title-four"class="inactive-title page-title">Generate Custom PDF: Image Uploads</h1>
        <h1 id="title-five"class="inactive-title page-title">Generate Custom PDF: STP File Uploads</h1>
