...
<div id="single-prod-main-container" class="col-10 mx-auto">
    ...
    <div id="single-prod-main" class="row mx-5 px-5">
        <div class="single-prod-left-col col-lg-8 px-3 py-5">
            <div class="left-info">
                <h1 class="page-title">1300 Series</h1>
                <h3 class="product-name">Flow Regulator</h3>
                <p class="product-info">INLINE • FEMALE NPTF PORTS</p>
            </div>

            <div class="left-desc">
                <h3 class="product-name">Description</h3>
                <p class="product-info">
                    AN IN-LINE, PRESSURE-COMPENSATED, NONADJUSTABLE FLOW REGULATOR WITH FEMALE NPTF PORTS, INTENDED FOR FIXED DISPLACEMENT HYDRAULIC CIRCUIT APPLICATIONS.
                </p>
            </div>
