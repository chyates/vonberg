...
<div id="gen-info-main-container" class="col-lg-10 mx-auto p-5">
    <div class="col-lg-6 mx-auto">
        ...
        <div class="resource-block p-4 my-4">
        ...
        <button type="button" class="d-block mx-auto btn btn-primary contact-us">Contact Us</button>
    </div>
