<div id="gen-info-main-container" class="inner-main col-lg-10 col-12 mx-auto p-lg-5 p-3">
    <div class="col-lg-6 col-12 mx-auto">
        ...
        <div class="resource-block p-sm-4 p-3 my-4">
            <p class="resource-link"><span class="pr-3"><img class="img-fluid" src="{% static 'users/Adobe_PDF_file_icon@2x.png' %}"/></span><a href="/pdf">Downloadable PDF 1</a></p>
            <p class="resource-link"><span class="pr-3"><img class="img-fluid" src="{% static 'users/Adobe_PDF_file_icon@2x.png' %}"/></span><a href="/pdf">Downloadable PDF 2 with even longer title that wraps around to second line</a></p>
        </div>
